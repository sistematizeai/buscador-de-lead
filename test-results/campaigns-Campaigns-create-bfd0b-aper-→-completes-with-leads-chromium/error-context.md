...
- Name: campaigns.spec.ts >> Campaigns >> create campaign → starts scraper → completes with leads
- Location: tests\e2e\campaigns.spec.ts:24:7
      ...
      - generic [ref=e30]:
        ...
        - generic [ref=e34]:
          ...
          - textbox "E-mail" [ref=e35]:
            ...
            - text: e2e-1782572546386-3451@prospex.test
        - generic [ref=e36]:
          - text: Senha
